...
#old build, with churn for node-density-cni, but wrong churnStart/churnEnd timestamps
...
#correct churnStart/churnEnd correct timestamps, without --worker-nodes hack
...
#rds
#kube-burner-ocp rds-core --gc-metrics=true --dpdk-cores=2 --perf-profile=customcnf --gc=false --service-latency=true --churn=false --iterations 99 --es-server=https://admin:nKNQ9=vw_bwaSy1@search-perfscale-pro-wxrjvmobqs7gsyi3xvxkqmn7am.us-west-2.es.amazonaws.com:443 --es-index=ripsaw-kube-burner
